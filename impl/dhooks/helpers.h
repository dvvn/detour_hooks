...
namespace dhooks
{
	...
	void* _Pointer_to_class_method(Ret (__thiscall C::*fn)(Args ...))
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__thiscall C::*fn)(Args ...) const)
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__fastcall C::*fn)(Args ...))
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__fastcall C::*fn)(Args ...) const)
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__stdcall C::*fn)(Args ...))
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__stdcall C::*fn)(Args ...) const)
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__cdecl C::*fn)(Args ...))
	{
		return detail::_Ptr_to_fn(fn);
	}

	template <typename Ret, typename C, typename ...Args>
	void* _Pointer_to_class_method(Ret (__cdecl C::*fn)(Args ...) const)
	{
		return detail::_Ptr_to_fn(fn);
	}
